...
Ropach comprend 2 parties : une partie destinée aux parents d’élèves, leur permettant d'ajouter leurs enfants sur le site et de les inscrire aux prestations de l’établissement scolaire de ceux-ci, ainsi qu’une partie administrateur, utilisée par les cantinières des écoles et par le personnel de RPC afin de réserver les repas pour les enfants et les employés.
...
- Implémentation d'un lecteur de pdf avec PDFjs
